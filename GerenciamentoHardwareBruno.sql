...
ALTER TABLE laboratorios ADD COLUMN localizacao VARCHAR(100) NOT NULL;
ALTER TABLE laboratorios MODIFY COLUMN localizacao VARCHAR(100) NOT NULL DEFAULT 'Localização padrão';
ALTER TABLE maquinas ADD COLUMN localizacao VARCHAR(255);
ALTER TABLE maquinas ADD COLUMN laboratorio_id INT;
